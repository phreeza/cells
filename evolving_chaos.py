...
CallForHelpGene = genes.make_normally_perturbed_gene(0.1)
CallOfDutyGene = genes.make_normally_perturbed_gene(0.1)
DraftDodgerGene = genes.make_normally_perturbed_gene(0.1)
